...
def get_fighter_url(fighter):
    ...
    if url:
       ...
       return 'https://pngimage.net/wp-content/uploads/2018/06/image-not-found-png-9.png'
...
app.layout = html.Div( style={'backgroundColor': colors['background'],
    ...
    html.Div(style={'textAlign': 'center'}, children=[
        ...
        html.Div(style={'width': '30%', 'display': 'inline-block', 'textAlign': 'center'}, children=[
            ...
            html.Label('Select Weightclass',
                ...
                dcc.Dropdown(
                    id='weightclass',
                    options=[{'label': wt.upper(), 'value': wt} for wt in df_weight_classes.keys()],
                    value='Lightweight'
                ),
            ...
            html.Label('Number of Rounds',
                ...
                dcc.Dropdown(
                    id='no_of_rounds',
                    options=[{'label': '5 Rounds', 'value': 5}, 
        ...
        html.Div(style={'width': '40%', 'marginLeft': 'auto', 'marginRight': 'auto', 'textAlign': 'left'
            ...
            html.Div(style={
                ...
                children=[
                    ...
                    html.H3(children=['click \n predict'], id='red-proba', style={'textAlign': 'center'})
            ...
            html.Div(style={
                ...
                children=[
                    ...
                    html.H3(children=['click \n predict'], id='blue-proba', style={'textAlign': 'center'})
...
@app.callback(
    Output('fight_type', 'options'),
    [Input('no_of_rounds', 'value')]
)
...
@app.callback(
    Output('red-fighter', 'options'),
    [Input('weightclass', 'value')]
)
def set_red_fighter(weightclass):
    
    return [{'label': i, 'value': i} for i in
            weight_classes[weight_classes['weight_class'] == weightclass]['fighter'].sort_values()]


@app.callback(
    Output('red-fighter', 'value'),
    [Input('red-fighter', 'options')]
)
...
def set_blue_fighter(weightclass, red_fighter):
    ...
    return [{'label': i, 'value': i} for i in
            blue_weight_classes[blue_weight_classes['weight_class'] == weightclass]['fighter'].sort_values()]


@app.callback(
    Output('blue-fighter', 'value'),
    [Input('blue-fighter', 'options')]
)
...
@app.callback(
    Output('blue-image', 'src'),
    [Input('blue-fighter', 'value')]
)
...
@app.callback(
    ...
    [Output('red-proba', 'children'),
    Output('blue-proba', 'children')],
    [Input('button', 'n_clicks')],
     state=[State('red-fighter', 'value'),
...
def update_proba(nclicks, red, blue, weightclass, no_of_rounds, fight_type):
    ...
    if nclicks:
        ...
        if red==blue:
            return ("Error: Select different fighters","Error: Select different fighters")
        ...
        cols_dict.update({'title_bout':title_bout[fight_type], 'no_of_rounds':no_of_rounds})
        ...
        [blue_proba,red_proba] = model.predict_proba(np.array(normalize(final, scaler)))[0]
